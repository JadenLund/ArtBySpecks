...
export default function Home() {
    return (
        <div>
            ...
            <img className='Image11' src={Image11} alt='Image11' />
            <img className='Image12' src={Image12} alt='Image12' />
            <img className='Image13' src={Image13} alt='Image13' />
            <img className='Image14' src={Image14} alt='Image14' />
